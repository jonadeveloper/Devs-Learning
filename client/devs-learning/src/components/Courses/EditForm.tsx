...
import { createCourseAction, editCourseAction, getCoursesByName } from "../../redux/courses/actions";
...
export const EditForm = () => {
    ...
    const { categories, status, currentCourse } = useAppSelector((state) => state.courses);
    useEffect(() => {
        if (name) {
